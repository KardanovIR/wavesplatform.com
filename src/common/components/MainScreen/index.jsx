    ...
    <div className={classes.inner}>
      ...
      {(imageDesktop || imageDesktop) && (
        <Col
          ...
          sm={5}
          lg={6}
          className={cn(classes.imageCol, { [classes.imageColMargin]: imageMobile })}
        >
          <div
          ...
          >
            <div className={classes.imageWrapper}>
              {!!imageMobile && (
                <div className={cn(classes.image, classes.xsOnly)}>{imageMobile}</div>
              )}
              {!!imageDesktop && (
                <div className={cn(classes.image, classes.xsHidden)}>{imageDesktop}</div>
              )}
            </div>
          </div>
        </Col>
