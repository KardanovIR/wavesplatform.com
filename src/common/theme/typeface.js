    ...
    '@font-face': [
        {
            fontFamily: 'TTNorms',
            src: [
                `url(${require('./fonts/TTNorms-Bold.woff2')})`,
        ...
        },
        {
            fontFamily: 'TTNorms',
            src: [
                `url(${require('./fonts/TTNorms-Medium.woff2')})`,
        ...
        },
        {
            fontFamily: 'TTNorms',
            src: [
                `url(${require('./fonts/TTNorms-Italic.woff2')})`,
        ...
        },
        {
            fontFamily: 'TTNorms',
            src: [
                `url(${require('./fonts/TTNorms-Regular.woff2')})`,
