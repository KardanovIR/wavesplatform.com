...
const StartMining = ({ classes }) => (
  <div>
    <SectionTitleText
      title={<FormattedMessage id="mining.startMining.title" />}
      text={
        <FormattedMessage
          ...
          values={{
            leasingLink: (
              <Link href={url('leasing')}>
                <FormattedMessage id="mining.startMining.leasingLink" />
              </Link>
            ),
          }}
        />
    ...
    <Row>
      <Col xs={12} sm={6} lg={3} className={classes.col}>
        ...
        <Typography tagName="div" align="center" className={classes.message}>
          <FormattedMessage id="mining.startMining.download.title" />
        </Typography>
        <Margin bottom={2} />
      ...
      <Col xs={12} sm={6} lg={3} className={classes.col}>
        ...
        <Margin bottom={1} />
        <Typography tagName="div" align="center" className={classes.message}>
          <FormattedMessage id="mining.startMining.install.title" />
        </Typography>
        <Margin bottom={2} />
        <IconButton
      ...
      <Col xs={12} sm={6} lg={3} className={classes.col}>
        ...
        <Margin bottom={1} />
        <Typography tagName="div" align="center" className={classes.message}>
          <FormattedMessage id="mining.startMining.configure.title" />
        </Typography>
        <Margin bottom={2} />
        <IconButton
          ...
          secondary
        >
          <FormattedMessage id="mining.startMining.configure.button" />
        </IconButton>
        <Margin bottom={5} />
      </Col>
      ...
      <Col xs={12} sm={6} lg={3} className={classes.col}>
        ...
        <Margin bottom={1} />
        <Typography tagName="div" align="center" className={classes.message}>
          <FormattedMessage id="mining.startMining.done.title" />
        </Typography>
        <Margin bottom={2} />
      </Col>
    </Row>
