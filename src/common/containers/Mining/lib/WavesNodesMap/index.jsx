...
const WavesNodesMap = ({ classes }) => (
  <div>
    <SectionTitleText
      title={<FormattedMessage id="mining.wavesNodesMap.title" />}
      text={<FormattedMessage id="mining.wavesNodesMap.text" />}
      marginSize={3}
    />
    ...
    <div className={classes.numbersWrapper}>
      <div className={classes.number}>
        ...
        <Typography type="body" tagName="span">
          <FormattedMessage id="mining.wavesNodesMap.nodes" />
        </Typography>
      </div>
      <div className={classes.number}>
        <Typography type="numeral" tagName="span">
        ...
        <Typography type="body" tagName="span">
          <FormattedMessage id="mining.wavesNodesMap.countries" />
        </Typography>
      </div>
    </div>
    <Margin />
