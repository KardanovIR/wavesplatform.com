...
const WavesNodes = ({ wavesTopNodes }) => {
  ...
  return wavesGo && WavesNodeNet ? (
    <div>
      <SectionTitleText
        title={<FormattedMessage id="mining.nodes.title" />}
        text={
          <FormattedMessage
      ...
      <Row>
        ...
        <Col xs={12} sm={6} lgOffset={1} lg={6}>
          <Typography type="display1">
            <FormattedMessage id="mining.nodes.node1.title" />
          </Typography>

          <Margin />

          <Quote
            signature={<FormattedMessage id="mining.nodes.node1.signature" />}
          >
            <FormattedMessage id="mining.nodes.node1.quote" />
          </Quote>
        </Col>
      </Row>
      ...
      <Row>
        ...
        <Col xs={12} sm={6} lgOffset={1} lg={6}>
          <Typography type="display1">
            <FormattedMessage id="mining.nodes.node2.title" />
          </Typography>

          <Margin />

          <Quote
            signature={<FormattedMessage id="mining.nodes.node2.signature" />}
          >
            <FormattedMessage id="mining.nodes.node2.quote" />
          </Quote>
        </Col>
      </Row>
    </div>
